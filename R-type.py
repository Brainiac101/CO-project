...
def beq(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "000" + "imm part 2" + "1100011";

def bne(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "001" + "imm part 2" + "1100011";

def blt(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "100" + "imm part 2" + "1100011";

def bge(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "101" + "imm part 2" + "1100011";

def bltu(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "110" + "imm part 2" + "1100011";

def bgeu(l, dict):
    return " imm " + dict[l[2]] + dict[l[1]] + "111" + "imm part 2" + "1100011";
...
for line in fin:
    ...
    if l[0]=="add":
        ...
        fout.write(beq(l,dict))
    elif l[0]=="bne":
        fout.write(bne(l,dict))
    elif l[0]=="bge":
        fout.write(bge(l,dict))
    elif l[0]=="bgeu":
        fout.write(bgeu(l,dict))
    elif l[0]=="blt":
        fout.write(blt(l,dict))
    elif l[0]=="bltu":
        fout.write(bltu(l,dict))
    fout.write("\n")
fin.close()
fout.close()
